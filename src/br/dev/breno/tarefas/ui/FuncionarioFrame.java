...
//		btnSair.setBackground(Color.RED);
		...
		btnSalvar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (sucesso) {
					//JOptionPane imprimir mensagem após o buttom for acionado, para exibir se ação foi realizada com sucesso
					JOptionPane.showMessageDialog(telaFuncionario, "Funcionário gravado com sucesso");
					limparFormulario();
				} else {
					JOptionPane.showMessageDialog(telaFuncionario, "Ocorreu umerro na gravação.\nTente novamente.\nSe o problema persistir, entre em contato com o suporte");
				}
			}
		});
		btnSair.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int resposta = JOptionPane.showConfirmDialog(telaFuncionario, "Deseja sair do sistema?","Ateção",JOptionPane.YES_NO_OPTION);
